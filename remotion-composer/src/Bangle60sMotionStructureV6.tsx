...
const shots: Shot[] = [
  ...
  { id: "03", image: "04.png", start: 8, aiVideo: "angle_pale_v3_4s.mp4", scale: [1.04, 1.12], x: [.7, -.2], y: [-.7, -.3], objectPosition: "50% 50%", accent: "rgba(203,231,219,.09)" },
  ...
  { id: "06", image: "04.png", start: 20, aiVideo: "diagonal_pale_v3_4s.mp4", scale: [1.04, 1.16], x: [-1.0, .5], y: [.2, -.5], objectPosition: "50% 52%", accent: "rgba(235,221,195,.10)", lightBridge: true },
  { id: "07", image: "04.png", start: 24, scale: [1.14, 1.05], x: [-.2, -1.0], y: [-.3, .2], objectPosition: "50% 50%", accent: "rgba(203,231,219,.08)" },
  { id: "08", image: "04.png", start: 28, scale: [1.14, 1.05], x: [-.2, -1.0], y: [-.3, .2], objectPosition: "50% 50%", accent: "rgba(203,231,219,.08)" },
  { id: "09", image: "04.png", start: 32, aiVideo: "phase4_beat09_candidate_01.mp4", scale: [1.06, 1.18], x: [.5, -1.0], y: [-.5, -.1], objectPosition: "50% 50%", accent: "rgba(230,218,197,.08)" },
...
export const Bangle60sMotionStructureV6: React.FC = () => (
...
export const BANGLE_60S_MOTION_STRUCTURE_V6_DURATION = 60 * FPS;
