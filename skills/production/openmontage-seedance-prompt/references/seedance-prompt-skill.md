<!--
Vendored from: https://github.com/songguoxs/seedance-prompt-skill
Path: .claude/skills/seedance/SKILL.md
License: MIT (upstream)
Note: BootStrap 执行时先读同目录上级 SKILL.md 的契约覆盖；渠模以 03 锁定为准。
-->
---
name: seedance
